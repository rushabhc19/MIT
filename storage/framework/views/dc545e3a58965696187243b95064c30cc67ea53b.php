...
<?php $__env->startSection('content'); ?>
                                                            ...
                                                            <div class="collapseTwo card-collapse collapse <?php if($user->profile->avatar_status == 1): ?> show <?php endif; ?>">
                                                                <div class="card-body">
                                                                    ...
                                                                    <?php echo Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone','id' => 'avatarDropzone', 'class' => 'form single-dropzone dropzone single', 'files' => true)); ?>
                                                                        ...
                                                                        <img id="user_selected_avatar" class="user-avatar" src="<?php if($user->profile->avatar != NULL): ?> <?php echo e(url($user->profile->avatar)); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>">
                                                                    <?php echo Form::close(); ?>
    ...
    <?php echo $__env->make('modals.modal-form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('footer_scripts'); ?>

    <?php echo $__env->make('scripts.form-modal-script', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php if(config('settings.googleMapsAPIStatus')): ?>
        <?php echo $__env->make('scripts.gmaps-address-lookup-api3', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>

    <?php echo $__env->make('scripts.user-avatar-dz', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
