			...
			<div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
				<div class="card">
					...
					<div class="card-body">
    					...
    					<img src="<?php if($user->profile->avatar_status == 1): ?> <?php echo e(url($user->profile->avatar)); ?> <?php else: ?> <?php echo e(Gravatar::get($user->email)); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>" class="user-avatar">
...
<?php $__env->startSection('footer_scripts'); ?>
	...
	<?php if(config('settings.googleMapsAPIStatus')): ?>
		<?php echo $__env->make('scripts.google-maps-geocode-and-map', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<?php endif; ?>
