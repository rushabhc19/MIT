                ...
                <div class="card">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?php echo e(url('/users/create')); ?>">
                                        <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                        <?php echo trans('usersmanagement.buttons.create-new'); ?>

                                    </a>
                                    <a class="dropdown-item" href="<?php echo e(url('/users/deleted')); ?>">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(config('usersmanagement.enableSearchUsers')): ?>
                            <?php echo $__env->make('partials.search-users-form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <?php endif; ?>
    <?php if(config('usersmanagement.enableSearchUsers')): ?>
        <?php echo $__env->make('scripts.search-users', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
