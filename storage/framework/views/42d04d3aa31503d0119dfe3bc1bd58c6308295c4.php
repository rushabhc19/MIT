          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-4 offset-sm-2 col-md-2 offset-md-3">
                <img src="<?php if($user->profile && $user->profile->avatar_status == 1): ?> <?php echo e(url($user->profile->avatar)); ?> <?php else: ?> <?php echo e(Gravatar::get($user->email)); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle center-block mb-3 mt-4 user-image">
              </div>
              <div class="col-sm-4 col-md-6">
                ...
                <?php if($user->profile): ?>
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <a href="<?php echo e(url('/users/'.$user->id.'/edit')); ?>" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('usersmanagement.editUser')); ?>">
